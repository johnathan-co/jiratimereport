...
MY_ADDRESS='emailhere@gmail.com'
...
def main():
    ...
    message = 'Attached is your time report for Jira!'
    ...
    filename = "jira-time-report.xlsx"
    attachment = open("jira-time-report.xlsx", "rb")
